...
in trivial test cases. To perform accurate measurements, I developed a
sample banking application. In this application's domain there is a
...
In Figure~\ref{fig:comparisonBPlus} we can see that the running time
