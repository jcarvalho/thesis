...
\usepackage[left=3.5cm,right=3.2cm,top=2.5cm,bottom=2.5cm]{geometry}
...
presented in this thesis aims at providing a solution that:
...
\clearpage \bibliography{biblio.bib} \bibliographystyle{plain}
\end{document}