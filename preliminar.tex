...
Presidente: ??\\
Orientador: Doutor João Cachopo\\
Vogais: Doutor 2\\
\end{center}
\vfil
}
...
Memories (PSTM) was born. In this project, I propose an extension to
PSTMs to support Long-Lived Transactions. My thesis is that supporting
Long-Lived Transactions should be done at the infrastructural level on
Persistent STMs, so I will describe how those systems can be extended
to support Long-Lived Transactions.
