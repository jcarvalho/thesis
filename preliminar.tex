...
\bf\centerline{Information Systems and Computer Engineering}
\vfil
}
...
\vfil
\begin{center}
{\fontsize{14}{14}\selectfont\bf Examination Committee}\\
\end{center}
\vfil
}
...
Supervisor: Prof. João Manuel Pinheiro Cachopo\\
Member of the Committee: Prof. João Ricardo Viegas da Costa Seco\\
\end{center}
\vfil
}
